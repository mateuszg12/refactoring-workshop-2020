...
bool Controller::checkForCollisions(Segment newHead)
{
...
void Controller::placeFood(EventT<FoodResp> const& requestedFood)
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        ...
        if (not lost) {
            lost = checkForCollisions(newHead);
        }
